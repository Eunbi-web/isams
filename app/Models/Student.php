...
class Student extends Model {
    ...
    protected $fillable = ['user_id','first_name','middle_name','last_name','student_id','course','department','year_level','section','academic_year','semester','enrollment_type','gwa','status','birthdate','sex','civil_status','contact_number','email','address','photo','guardian_name','guardian_relationship','guardian_contact'];
