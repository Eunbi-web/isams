...
class StudentController extends Controller {
    ...
    public function index(Request $r) {
        ...
        return view('scholarship.students.index', compact('students','courses','years'));
    }

    public function create()  { return view('scholarship.students.create'); }
    ...
    public function store(Request $r) {
        ...
        return redirect()->route('scholarship.students.index')->with('success','Student added!');
    }

    public function show(Student $student)  { return view('scholarship.students.show',compact('student')); }
    public function edit(Student $student)  { return view('scholarship.students.edit',compact('student')); }

    public function update(Request $r, Student $student) {
        $student->update($r->all());
        $this->ensureStudentUser($student);
        return redirect()->route('scholarship.students.show',$student)->with('success','Updated!');
    }

    public function destroy(Student $student) {
        $student->delete();
        return redirect()->route('scholarship.students.index')->with('success','Deleted.');
    }

    public function export() { return response()->json(Student::all()); }

    public function importForm() {
        return view('scholarship.students.import');
    }
    ...
    public function import(Request $request) {
        ...
        return view('scholarship.students.import', compact('summary'));
    }
