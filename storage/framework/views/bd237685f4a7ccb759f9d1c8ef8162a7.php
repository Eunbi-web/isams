...
<?php $__env->startSection('page-title','New Application'); ?>
<?php $__env->startSection('content'); ?>
<div style="max-width:700px;">
<form method="POST" action="<?php echo e(route('admin.applications.store')); ?>"><?php echo csrf_field(); ?>
...
<div class="g2">
<div class="fg"><label class="fl">Student <span style="color:var(--danger);">*</span></label><select name="student_id" class="fc" required><option value="">Select student...</option><?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><option value="<?php echo e($s->id); ?>"><?php echo e($s->full_name); ?> (<?php echo e($s->student_id); ?>)</option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></select></div>
<div class="fg"><label class="fl">Scholarship <span style="color:var(--danger);">*</span></label><select name="scholarship_id" class="fc" required><option value="">Select scholarship...</option><?php $__currentLoopData = $scholarships; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><option value="<?php echo e($sch->id); ?>"><?php echo e($sch->name); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></select></div>
</div>
<div class="g2">
...
<div style="display:flex;gap:10px;"><button type="submit" class="btn btn-p"><i class="fas fa-paper-plane"></i> Submit Application</button><a href="<?php echo e(route('admin.applications.index')); ?>" class="btn btn-o">Cancel</a></div>
</form></div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Acer\Herd\isams\resources\views/admin/applications/create.blade.php ENDPATH**/ ?>