...
<a href="<?php echo e(route('admin.announcements.index')); ?>" class="nav-a <?php echo e(request()->routeIs('admin.announcements*')?'active':''); ?>"><i class="fas fa-bullhorn"></i> Announcements</a>
<a href="<?php echo e(route('admin.discipline.index')); ?>" class="nav-a <?php echo e(request()->routeIs('admin.discipline*')?'active':''); ?>"><i class="fas fa-gavel"></i> Discipline Records</a></div>
