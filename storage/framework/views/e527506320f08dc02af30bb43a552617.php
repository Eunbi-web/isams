...
<div class="ai-bar">
    ...
    <div class="ai-bar-stats">
        ...
        <div class="ai-stat">Eligible: <strong><?php echo e($stats['eligible']); ?>/<?php echo e($stats['total']); ?></strong></div>
...
<div class="sg" style="grid-template-columns:repeat(4,1fr);margin-bottom:20px;">
    ...
    <div class="sc an d2"><div class="si g"><i class="fas fa-check-circle"></i></div><div class="sv"><div class="lbl">Eligible</div><div class="val"><?php echo e($stats['eligible']); ?><span style="font-size:16px;color:var(--tm);font-weight:600;">/<?php echo e($stats['total']); ?></span></div><div class="chg">Out of all evaluated</div></div></div>
    ...
    <div class="sc an d4"><div class="si y"><i class="fas fa-star"></i></div><div class="sv"><div class="lbl">Avg AI Score</div><div class="val"><?php echo e($stats['avg_score']); ?>%</div></div></div>
</div>
