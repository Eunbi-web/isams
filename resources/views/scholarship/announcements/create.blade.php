...
<form method="POST" action="{{ route('scholarship.announcements.store') }}">@csrf
...
<div style="display:flex;gap:10px;"><button type="submit" class="btn btn-p"><i class="fas fa-paper-plane"></i> Publish</button><a href="{{ route('scholarship.announcements.index') }}" class="btn btn-o">Cancel</a></div>
</form></div>
@endsection
