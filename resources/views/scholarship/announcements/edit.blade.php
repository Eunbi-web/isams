...
<form method="POST" action="{{ route('scholarship.announcements.update',$announcement->id) }}">@csrf @method('PUT')
...
<div style="display:flex;gap:10px;"><button type="submit" class="btn btn-p"><i class="fas fa-save"></i> Update</button><a href="{{ route('scholarship.announcements.index') }}" class="btn btn-o">Cancel</a></div>
</form></div>
@endsection
