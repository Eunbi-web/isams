...
@section('page-sub','All your system notifications')
@section('content')
...
<div class="card an">
    <div class="ch">
        ...
        <div class="ch-acts">
            ...
            <button type="button" onclick="markAllAdminRead()" class="btn btn-o btn-sm">
    ...
    <div>
        ...
        <div style="padding:40px;text-align:center;">
            ...
            <div style="font-size:13px;color:var(--tm);margin-top:4px;">You will see scholarship updates, application changes, and system alerts here.</div>
        </div>
        @endforelse
    </div>
...
function markOneRead(id) {
    fetch('/scholarship/notifications/' + id, {
        method: 'POST',
...
function markAllAdminRead() {
    fetch('/scholarship/notifications/mark-all', {
        method: 'POST',
        headers: {'X-CSRF-TOKEN': CSRF, 'X-Requested-With': 'XMLHttpRequest', 'Content-Type': 'application/json'},
        body: JSON.stringify({})
    }).then(function() {
