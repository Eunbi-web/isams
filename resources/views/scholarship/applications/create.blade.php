...
<form method="POST" action="{{ route('scholarship.applications.store') }}">@csrf
...
<div style="display:flex;gap:10px;"><button type="submit" class="btn btn-p"><i class="fas fa-paper-plane"></i> Submit Application</button><a href="{{ route('scholarship.applications.index') }}" class="btn btn-o">Cancel</a></div>
</form></div>
@endsection
