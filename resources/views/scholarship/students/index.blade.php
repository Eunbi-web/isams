...
<form method="GET" style="display:flex;gap:8px;flex-wrap:wrap;align-items:center;">
    ...
    <a href="{{ route('scholarship.students.index') }}" class="btn btn-o btn-sm">Clear</a>
</form>

<div style="display:flex;gap:8px;flex-wrap:wrap;align-items:center;">
    <a href="{{ route('scholarship.students.import-form') }}" class="btn btn-p btn-sm"><i class="fas fa-file-import"></i> Import Students</a>
    <a href="{{ route('scholarship.students.create') }}" class="btn btn-p btn-sm"><i class="fas fa-user-plus"></i> Add Student</a>
</div>
</div>
...
<td><div style="display:flex;gap:5px;"><a href="{{ route('scholarship.students.show',$s->id) }}" class="btn btn-o btn-sm btn-ic"><i class="fas fa-eye"></i></a><a href="{{ route('scholarship.students.edit',$s->id) }}" class="btn btn-o btn-sm btn-ic"><i class="fas fa-edit"></i></a></div></td>
</tr>
@empty
