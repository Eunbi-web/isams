...
<div style="max-width:760px;">
    <div style="display:flex;align-items:center;justify-content:space-between;gap:10px;flex-wrap:wrap;margin-bottom:14px;">
        <div style="display:flex;gap:8px;flex-wrap:wrap;">
            <a href="{{ route('scholarship.students.index') }}" class="btn btn-o btn-sm"><i class="fas fa-arrow-left"></i> Back</a>
        </div>
        <a href="{{ route('scholarship.students.export') }}" class="btn btn-o btn-sm" title="Export current students (JSON)"><i class="fas fa-download"></i> Export (JSON)</a>
    </div>
    ...
    <div class="card an mb3">
        ...
        <div class="cb">
            ...
            <form method="POST" action="{{ route('scholarship.students.import') }}" enctype="multipart/form-data">
                @csrf
        ...
        <div class="card an">
            ...
            <div class="cb">
                ...
                <div style="display:flex;gap:10px;justify-content:flex-end;flex-wrap:wrap;margin-top:16px;">
                    <a href="{{ route('scholarship.students.index') }}" class="btn btn-p"><i class="fas fa-users"></i> View Students</a>
                    <a href="{{ route('scholarship.students.create') }}" class="btn btn-o"><i class="fas fa-user-plus"></i> Add Student Manually</a>
                </div>
            </div>
        </div>
    @endif
