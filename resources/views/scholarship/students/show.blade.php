...
<div style="margin-bottom:14px;display:flex;gap:8px;"><a href="{{ route('scholarship.students.index') }}" class="btn btn-o btn-sm"><i class="fas fa-arrow-left"></i> Back</a><a href="{{ route('scholarship.students.edit',$student->id) }}" class="btn btn-p btn-sm"><i class="fas fa-edit"></i> Edit</a></div>
<div class="g2">
