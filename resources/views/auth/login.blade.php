...
body{
    ...
    position:relative;
    background-image:url('{{ asset('images/SCC_College_building.jpg') }}');
    ...
    <form method="POST" action="/login">
        ...
        <div class="fg">
            ...
            <div class="iw">
                ...
                <input type="email" name="email" class="fc" value="{{ old('email') }}" placeholder="Enter your email" required autofocus>
            </div>
        </div>
