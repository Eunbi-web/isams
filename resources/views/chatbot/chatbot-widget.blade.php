{{-- ===============================================
     ISAAC — Integrated Student Affairs AI Companion
     Self-contained chatbot widget (HTML/CSS/JS)
     Included before </body> in all 3 portal layouts
     =============================================== --}}
@php
...
<script>
(function () {
    var ISAAC_FIRST_NAME = @json($isaacFirstName);
    var ISAAC_ASK_URL = @json(route('chatbot.ask'));
