...
<a href="{{ route('admin.counseling.index') }}" class="nav-a {{ request()->routeIs('admin.counseling*')?'active':'' }}"><i class="fas fa-heart"></i> Counseling</a>
...
<a href="{{ route('admin.announcements.index') }}" class="nav-a {{ request()->routeIs('admin.announcements*')?'active':'' }}"><i class="fas fa-bullhorn"></i> Announcements</a></div>
